...
<head>
    ...
    <title>Enter Zone Name | Station Cleaning</title>
        ...
        <div class="p-6">
            ...
            <div class="card p-6">
                <div class="mb-6">
                    ...
                    <p class="text-gray-500 text-sm mt-1">Create a new Zone for your organization</p>
                </div>
                ...
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
                    <div class="mb-6">
                        ...
                        <input 
                            ...
                            required
                        >
                        <p class="mt-1 text-xs text-gray-500">Enter a unique name for the zone</p>
                    </div>
                    
                    <div class="flex items-center justify-between pt-4 border-t border-gray-200">
                        <a href="list-zone.php" class="btn-secondary">
                            Cancel
                        </a>
            ...
            <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="card p-5">
                    <div class="flex items-center mb-4">
                        ...
                        <h3 class="font-semibold">Tips for Creating Zones</h3>
                    </div>
                    <ul class="space-y-2 text-sm text-gray-600">
                        <li class="flex items-start">
                            <i class="fas fa-check-circle text-green-500 mt-1 mr-2"></i>
                            <span>Use clear, descriptive names for Zones</span>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-check-circle text-green-500 mt-1 mr-2"></i>
                        ...
                        <li class="flex items-start">
                            <i class="fas fa-check-circle text-green-500 mt-1 mr-2"></i>
                            <span>Ensure Zone names are unique across your organization</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="card p-5">
                    ...
                    <p class="text-sm text-gray-600 mb-4">
                        If you need assistance with creating zones or have questions about organization structure, 
