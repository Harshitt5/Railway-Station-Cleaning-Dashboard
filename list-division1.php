...
<head>
    ...
    <title>Zone List List | Station Cleaning</title>
...
<div class="flex min-h-screen">
    ...
    <div class="ml-0 md:ml-72 flex-1">
        ...
        <header class="bg-white shadow-sm sticky top-0 z-10">
            <div class="flex items-center justify-between px-6 py-4">
                ...
                <div class="flex items-center space-x-4">
                    <a href="create-zone.php" class="btn btn-primary">
        ...
        <div class="p-6">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="text-gray-700">Zones</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <!-- Overview Section -->
            <div class="mb-6">
                <h2 class="text-2xl font-bold text-gray-800 mb-4">Zones List</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    <div class="card p-5">
                        <div class="flex items-center">
                            ...
                            <div>
                                <p class="text-gray-500 text-sm">Total Zones</p>
            ...
            <div class="card mb-6">
                <div class="p-4 border-b border-gray-200">
                    <div class="flex flex-wrap items-center justify-between">
                        <h3 class="text-lg font-semibold text-gray-800">All Zones</h3>
                        
                        <div class="flex items-center space-x-2 mt-2 sm:mt-0">
                            <div class="relative">
                                <input type="text" placeholder="Search zones..." class="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                ...
                <div class="flex items-center justify-between p-4 border-t border-gray-200">
                    <div class="text-sm text-gray-500">
                        Showing <span class="font-medium"></span> zones
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div class="card p-4">
                    <div class="flex items-center mb-4">
                        ...
                        <h3 class="font-semibold">Managing Zones</h3>
                    </div>
                    <p class="text-sm text-gray-600 mb-4">
                        Zones help you organize stations within your railway network. 
                        Create zones based on geographical areas
                    </p>
                    <a href="#" class="text-sm text-blue-600 font-medium hover:text-blue-800 flex items-center">
                        <span>Learn more about zones</span>
                ...
                <div class="card p-4">
                    ...
                    <p class="text-sm text-gray-600 mb-4">
                        ...
                        zones or setting up your organization structure.
                    </p>
