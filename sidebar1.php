    ...
    <nav class="p-4">
        ...
        <div class="mb-2">
            ...
            <div class="pl-12 mt-1 space-y-1">
                <a href="create-division1.php" class="block py-2 px-3 rounded-lg hover:bg-gray-800 text-gray-400 hover:text-white transition-colors">
                    View Divisions
                </a>
                <a href="list-division1.php" class="block py-2 px-3 rounded-lg hover:bg-gray-800 text-gray-400 hover:text-white transition-colors">
                    Create Division
                </a>
            </div>
        </div>
